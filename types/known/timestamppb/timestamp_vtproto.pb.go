...
func (m *Timestamp) MarshalVTStable() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Timestamp) MarshalToVTStable(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStable(dAtA[:size])
}

func (m *Timestamp) MarshalToSizedBufferVTStable(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Timestamp) MarshalVTStableStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Timestamp) MarshalToVTStableStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStableStrict(dAtA[:size])
}

func (m *Timestamp) MarshalToSizedBufferVTStableStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
