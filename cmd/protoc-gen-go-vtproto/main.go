...
func main() {
	...
	cfg.Slab = generator.NewObjectSet()
	cfg.SlabExclude = generator.NewObjectSet()
	...
	f.Var(&cfg.Slab, "slab", "use slab-allocated unmarshalling for this object")
	f.Var(&cfg.SlabExclude, "slab-exclude", "do not use slab-allocated unmarshalling for this object")
